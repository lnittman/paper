...
import { paperTools as _paperMcpTools } from "./tools/paper-mcp.js";
...
export class AgentSession {
	...
	private _buildRuntime(options: {
		...
		// Paper fork: register Paper MCP tools as base tools (always available)
		for (const tool of _paperMcpTools) {
			this._baseToolRegistry.set(tool.name, tool as AgentTool);
		}
